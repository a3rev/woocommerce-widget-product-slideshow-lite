...
class Slider extends \WP_Widget
{
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset( $new_instance['widget_effect'] ) ) $instance['widget_effect'] = sanitize_key( $new_instance['widget_effect'] );
...
<legend><?php esc_html_e('Upgrade to','woo-widget-product-slideshow' ); ?> <a href="<?php echo WC_PRODUCT_SLIDER_VERSION_URI; ?>" target="_blank"><?php esc_html_e('Carousel & Slider Version', 'woo-widget-product-slideshow' ); ?></a> <?php esc_html_e('to activate', 'woo-widget-product-slideshow' ); ?></legend>
<p>
...
<p id="<?php echo $this->get_field_id('show_type'); ?>_filter" >
	<label for="<?php echo $this->get_field_id('filter_type'); ?>_pro"><strong><?php esc_html_e('Filter:', 'woo-widget-product-slideshow' ); ?></strong></label>
...
<p><label><strong><?php esc_html_e( 'Skin Type:', 'woo-widget-product-slideshow' ); ?></strong></label>
	<label><input type="radio" class="wc_product_slider_skin_type" data-id="<?php echo $this->get_field_id('skin_type'); ?>" name="<?php echo $this->get_field_name('skin_type'); ?>" value="widget" checked="checked" /> <?php esc_html_e( 'WIDGET', 'woo-widget-product-slideshow' ); ?></label> &nbsp;&nbsp;&nbsp;
	<label><input type="radio" class="wc_product_slider_skin_type" data-id="<?php echo $this->get_field_id('skin_type'); ?>" name="<?php echo $this->get_field_name('skin_type'); ?>" value="card" /> <?php esc_html_e( 'CARD', 'woo-widget-product-slideshow' ); ?></label>
</p>
