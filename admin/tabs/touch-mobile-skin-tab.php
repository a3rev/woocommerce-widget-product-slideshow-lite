...
class WC_Product_Slider_Mobile_Skin_Settings_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'mobile-skin',
			'label'				=> __( 'Mobile Skin', 'woo-widget-product-slideshow' ),
			'callback_function'	=> 'wc_product_slider_mobile_skin_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/mobile-skin/skin-settings.php' );
...
global $wc_product_slider_mobile_skin_settings_tab;
$wc_product_slider_mobile_skin_settings_tab = new WC_Product_Slider_Mobile_Skin_Settings_Tab();

/** 
 * wc_product_slider_mobile_skin_settings_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_mobile_skin_settings_tab_manager() {
	global $wc_product_slider_mobile_skin_settings_tab;
	$wc_product_slider_mobile_skin_settings_tab->tab_manager();
}
