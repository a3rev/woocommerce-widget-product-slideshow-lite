...
class WC_Product_Slider_Carousel_Settings_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'carousel-skin',
			'label'				=> __( 'Carousel Container', 'woo-widget-product-slideshow' ),
			'callback_function'	=> 'wc_product_slider_carousel_settings_tab_manager',
		);
...
global $wc_product_slider_carousel_settings_tab;
$wc_product_slider_carousel_settings_tab = new WC_Product_Slider_Carousel_Settings_Tab();

/** 
 * wc_product_slider_carousel_settings_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_carousel_settings_tab_manager() {
	global $wc_product_slider_carousel_settings_tab;
	$wc_product_slider_carousel_settings_tab->tab_manager();
}
